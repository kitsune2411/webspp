...
if (isset($_POST['submit'])) {
    ...
    if ($pass == $confirm_pass) {
        if ($admin->updatePetugas($id, $name, $username, $pass, $level)) {
...
<div class="container-fluid">
    ...
    <form class="user" method="POST" action="">
        <?php
        foreach($admin->getDataPetugas($id) as $edit) :
        ?>
        <label for="fullname">Nama Lengkap</label>
        <div class="form-group">
            <input type="text" class="form-control " id="fullname" placeholder="Masukan Nama Lengkap" name="name" value="<?=$edit['nama_petugas']?>" required>
        </div>
        ...
        <div class="form-group row">
            <div class="col-sm-6 mb-3 mb-sm-0">
                <input type="text" class="form-control " id="username" placeholder="Masukan Username" name="username" value="<?=$edit['username']?>" required>
            </div>
            <div class="col-sm-6">
